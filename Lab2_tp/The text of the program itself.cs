...
namespace Lab02
{
 ...
 Console.WriteLine("Вы можете ничего не вводить,ввести только брэнд, ввести брэнд и модель либо сразу все три параметра!");
 Console.WriteLine("Введите 1 для режима «Зерновые», 2 для «Тушение», 3 для «Жарка», 4 для «Пар».");
...
for (; ; )
 ...
 {
 Console.WriteLine($"Есть {objects.Count} мультиварки(ок). Выбирете одну из них или введите 'с', чтобы создать новую.");
 for (; ; )
 {
